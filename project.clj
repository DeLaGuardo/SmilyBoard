...
(defproject SmilyBoard "0.0.1-SNAPSHOT" ; version "1.0.0-SNAPSHOT"
  ...
  :description "Board for check and define daily mood with smiles pics."
  :url "https://github.com/DeLaGuardo/SmilyBoard"
  ...
  ; TODO: (DeLaGuardo) uncomment when some exclusions will needed
  ...
  :pom-addition [:developers [:developer [:name "DeLaGuardo"]]]
  )
